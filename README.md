...
This is a Language Translator app built using `PHP`, `HTML`, `CSS`, `JS`. This app detects the language automatically and can be translated into any of the desired language choosen. See the website live [here](https://language-translator-abhi6722.herokuapp.com).
